...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "glass inline-flex h-11 items-center justify-center rounded-lg p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
