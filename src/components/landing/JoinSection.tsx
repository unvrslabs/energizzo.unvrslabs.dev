...
export function JoinSection() {
  return (
    <section id="iscrizione" className="mx-auto max-w-6xl px-4 sm:px-6 py-14 sm:py-20 md:py-24">
      ...
      <div className="grid gap-4 sm:gap-6 md:grid-cols-3 md:items-stretch">
        {/* LEFT */}
        <article className="dispaccio-card dispaccio-card-hover p-5 sm:p-8 flex flex-col">
        ...
        <div className="relative md:scale-[1.03]">
          ...
          <article
            className="dispaccio-card p-5 sm:p-8 flex flex-col h-full border border-primary/40"
            style={{
              boxShadow:
                "0 0 0 1px hsl(158 64% 42% / 0.25), 0 20px 60px hsl(158 64% 42% / 0.2)",
            }}
          >
            <h3 className="text-xl sm:text-2xl font-bold tracking-tight">Network Core</h3>
            ...
            <a
              ...
              className="btn-premium mt-6 sm:mt-8 px-6 py-3 rounded-full font-semibold text-sm w-full"
            >
