...
export function Footer() {
  return (
    <footer className="border-t border-border/40 mt-8">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-12 flex flex-col gap-6 sm:gap-8 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="border-t border-border/20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-5 sm:py-6 text-[11px] text-muted-foreground/60 text-center">
