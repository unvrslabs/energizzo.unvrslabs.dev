...
const SEC = {
  ...
  s7: { label: "Accesso al network", index: 7 },
} as const;
...
export const SURVEY_SCREENS: Screen[] = [
  ...
  },
  {
    ...
    type: "multi_choice",
    section: SEC.s5,
    title: "Gestionale verticale energia in uso",
    description:
      "Piattaforma principale per la gestione commerciale, pipeline e reportistica direzionale. Puoi selezionare fino a 2 voci.",
    required: true,
    maxSelections: 2,
    options: [
      "Energizzo",
  ...
  },
  {
    ...
    type: "single_choice",
    section: SEC.s5,
    title: "A che punto siete con l'intelligenza artificiale nel back-office?",
    required: true,
    options: [
