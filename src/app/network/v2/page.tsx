  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <header className="flex items-end justify-between gap-4 flex-wrap pb-1">
        ...
        <Link href="/network/v2/delibere" className="v2-btn v2-btn--primary">
          Apri compliance
        ...
        <div className="v2-card v2-col-8">
          ...
          <div className="divide-y" style={{ borderColor: "hsl(var(--v2-border))" }}>
            {latest.map((d) => (
              <Link
                key={d.code}
                href={`/network/v2/delibere?open=${encodeURIComponent(d.code)}`}
        ...
        <div className="v2-card v2-col-6">
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-2 mt-4">
              <Link href="/network/v2/price-engine" className="v2-btn v2-btn--primary">
                Apri motore
          ...
          <div className="p-4 flex gap-4">
            ...
            <div className="flex-1 min-w-0 flex flex-col">
              ...
              <div className="flex items-center gap-2 mt-auto pt-3">
                ...
                <Link href="/network/v2/podcast" className="v2-btn">Archivio</Link>
              </div>
            </div>
          </div>
        </div>
